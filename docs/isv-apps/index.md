...
:class: small-sd-card
+++
<a href="isv-apps/ansys-fluent.md" class="card-header-link">
...
:class: small-sd-card
+++
<a href="isv-apps/ansys-mechanical.md" class="card-header-link">
...
:class: small-sd-card
+++
<a href="isv-apps/cadence-fidelity.md" class="card-header-link">
...
:class: small-sd-card
+++
<a href="isv-apps/devito.md" class="card-header-link">
...
:class: small-sd-card
+++
<a href="isv-apps/siemens.md" class="card-header-link">
...
:class: small-sd-card
+++
<a href="isv-apps/stone-ridge.md" class="card-header-link">
